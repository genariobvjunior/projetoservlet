...
<html lang="pt-br" class="hidden-menu-mobile-lock">
    <template:get name="cabecalho" />
    <body class="desktop-detected   fixed-header fixed-navigation fixed-ribbon fixed-page-footer  hidden-menu  pace-done">
