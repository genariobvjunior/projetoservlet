...
var handleRenderFormMaskedInput = function() {
	...
	$("#masked-input-date2").mask("99/99/9999");
	$("#masked-input-date3").mask("99/99/9999");
	$("#masked-input-date4").mask("99/99/9999");
	$("#masked-input-date5").mask("99/99/9999");
	...
	$("#masked-input-pc").mask("999.9999.999999");
	$("#masked-input-cpf").mask("999.999.999-99");
	$("#maskedlogin").mask("999.999.999-99");
	$("#masked-input-cnpj").mask("99.999.999/9999-99");
	$("#masked-input-celular").mask("(99) 999999999");
	$("#masked-input-cep").mask("99.999-999");
	$("#masked-input-fone").mask("(99) 9999-9999");
};
