  ...
  border-bottom-width: 0px;
		...
		<div id="content" class="app-content">
			...
			<ol class="breadcrumb float-xl-end">
				...
				<li class="breadcrumb-item active">Menu Plano Geral de Atuação</li>
			</ol>
			<!-- BEGIN page-header -->
			<h1 class="page-header"><i class="fas fa-fw me-10px fa-cubes me-10px"></i>&nbsp;MENU PLANO GERAL DE ATUAÇÃO
			&nbsp;<a href="javascript:;"
						...
						<tr class="bg-light">
							<td class="p-0">
								<table class="table table-condensed m-0 bg-none">
									<tbody>
										<tr>
											<td nowrap><a href="${pageContext.request.contextPath}/PlanoGeralAtuacaoListar" class="btn btn-outline-inverse" onclick="document.getElementById('carregando').style.display='';">CADASTROS</a></td>
										</tr>
									</tbody>
								</table>
							</td>
