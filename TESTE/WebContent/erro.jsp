...
<body class='pace-top'>
	...
	<div id="app" class="app">
		<!-- BEGIN error -->
		<div class="error">
			<div class="error-code">Erro no Sistema</div>
			<div class="error-content">
				<div class="error-message">ACONTECEU UM ERRO INESPERADO NO SISTEMA. </div>
				<div class="error-desc mb-4">
				 <br />
				</div>
				<div class="error-message">${erroCodigo} ${ERROQUERY}</div>
				<div class="error-message">FAVOR ENTRAR EM CONTATO COM NÚCLEO DE ATENDIMENTO AO USUÁRIO NA DITEC.</div>
				<div>
