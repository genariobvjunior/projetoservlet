	...
	<template:put name="conteudo" direct="true">
		...
		<div id="content" class="app-content">
			...
			<ol class="breadcrumb float-xl-end">
				...
				<li class="breadcrumb-item"><a
					href="${pageContext.request.contextPath}/MenuMapa">Menu
						Configurações</a></li>
				<li class="breadcrumb-item"><a
					href="${pageContext.request.contextPath}/TarefaListar">Tarefas</a></li>
				<li class="breadcrumb-item active">Alteração de Tarefas</li>
			</ol>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
				...
				<div class="col-xl-12">
					...
					<div class="panel panel-inverse"
						...
						<div class="panel-heading">
							<h4 class="panel-title">ALTERAÇÃO DE tarefa</h4>
						...
						<div class="panel-body">
							<form name="frmAlterar" method="POST" class="form-horizontal"
								...
								action="${pageContext.request.contextPath}/TarefaGravar">
								...
								<div class="form-group row mb-3">
									...
									<div class="col-lg-8">
										<input class="form-control" type="text" id="titulo" name="titulo" maxlength="100" value="${retorno.titulo}" data-parsley-required="true" autocomplete="off">
									</div>
								</div>
								<div class="form-group row mb-3">
									...
									<div class="col-lg-10">
										<textarea class="form-control" id="descricao" name="descricao" rows="3" data-parsley-minlength="5"
											data-parsley-required="true">${retorno.descricao}</textarea>
									</div>
								</div>
								<div class="form-group row mb-3">
									...
									<div class="col-lg-10">
										<select class="form-select" id="idStatus" name="idStatus" data-parsley-required="true">
											<option value="A" <c:if test="${retorno.status eq 'A'}"> selected </c:if>  >EM CONSTRUÇÃO</option>
											<option value="C" <c:if test="${retorno.status eq 'C'}"> selected </c:if>  >CONCLUÍDO</option>
										</select>
									</div>
								</div>
		...
		<script language="javascript">
			...
			document.frmAlterar.titulo.focus();
		</script>
	</template:put>
</template:insert>