	...
	<div id="app" class="app">
		...
		<div class="error">
			...
			<div class="error-content">
				<div class="error-message">ACONTECEU ALGO INESPERADO...</div>
				<div class="error-desc mb-4">
					FAVOR ENTRAR EM CONTATO COM O NÚCLEO DE ATENDIMENTO AO USUÁRIO NA DITEC.<br />
				</div>
				<div>
