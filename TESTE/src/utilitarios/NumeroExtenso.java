...
public class NumeroExtenso {
     ...
     * @since JDK 1.5
     */
    public NumeroExtenso(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public NumeroExtenso(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
...
//        NumeroExtenso teste = new NumeroExtenso(new BigDecimal(55000.69));
//
